...
####+BEGIN: bx:dblock:python:class :className "PalsRepo_Profile" :superClass "palsRepo.PalsRepo" :comment "Expected to be subclassed" :classType "basic"
"""
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  Class-basic :: /PalsRepo_Profile/ palsRepo.PalsRepo =Expected to be subclassed=  [[elisp:(org-cycle)][| ]]
"""
...
####+BEGIN: bx:dblock:python:class :className "PalsRepo_Profile_FPs" :superClass "fp.FP_Base" :comment "Expected to be subclassed" :classType "basic"
"""
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  Class-basic :: /PalsRepo_Profile_FPs/ fp.FP_Base =Expected to be subclassed=  [[elisp:(org-cycle)][| ]]
"""
class PalsRepo_Profile_FPs(fp.FP_Base):
####+END:
