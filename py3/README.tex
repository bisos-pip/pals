...
PALS: (Possession Assertible Libre Services) -- python library and scripts (Interactive Command Modules -- ICM)
are used to manage abstrations of ByStar Autonomy Assertable Internet Services BPOs
